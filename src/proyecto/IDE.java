...
public class IDE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem4.setText("Guardar GXML");
        ...
        jMenuItem6.setText("Guardar GXML");
...
//        }
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        if(result == JFileChooser.APPROVE_OPTION){
            ...
            display.fs_file = selected.getPath();
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        if(result == JFileChooser.APPROVE_OPTION){
            File selected = jFileChooser1.getSelectedFile();
            display.gxml_file = selected.getPath();
            display.home = selected.getParent();
            try {
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        try {
            FileWriter f = new FileWriter(display.fs_file, false);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        // TODO add your handling code here:
        try {
            FileWriter f = new FileWriter(display.gxml_file, false);
